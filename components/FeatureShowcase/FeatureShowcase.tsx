...
// // ---- Spotlight CSS (global-in-component) ----
...
//     mask: 
//       radial-gradient(
//         circle 80px at var(--spot-x) var(--spot-y),
//         transparent 0%,
//         transparent 40%,
//         black 75%
//       );
      ...
      {isOverlayOpen && activeSubPart && (
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              <h3 className="text-lg font-bold text-black">{activeSubPart.title}</h3>
            </div>
